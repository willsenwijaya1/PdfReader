...
if uploaded_files:
        ...
        with pdfplumber.open(pdf_path) as pdf:
            for page in pdf.pages:
                ...
                for table in tables:
                    ...
                    # Gabungkan baris terpotong antar halaman
    ...
    for row in range(0, len(df) - 1, 2):
        ...
        # Perbaiki nilai yang tidak sejajar
    ...
    # 3️⃣ Parsing Data ke Format Terstruktur
    ...
    # Format ulang tanggal dan ffill data kosong
...
st.info("Unggah file PDF untuk mulai ekstraksi dan pembersihan data!")

# 🚀 Siap deploy ke Streamlit! Let me know jika ada yang mau disesuaikan! ✌️
