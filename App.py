...
if uploaded_file:
    ...
    # 2️⃣ Ekstraksi Tabel dari PDF
    st.write("🔄 **Ekstraksi tabel dari PDF...**")
    ...
    if extract_tables_from_pdf(pdf_path, output_excel):
        st.success(f"✅ Tabel berhasil diekstrak dan disimpan ke **{output_excel}**")
    else:
        st.error("⚠ Tidak ada tabel yang dapat diekstrak!")
